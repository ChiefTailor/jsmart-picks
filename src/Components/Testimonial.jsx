...
const initialTestimonials = [
  {
    ...
    text: "J-Smart Picks consistently delivers winning strategies. Their insights have boosted my betting success dramatically.",
  },
  {
    name: "Sophia Carter",
    location: "Los Angeles, CA",
    text: "The attention to detail in J-Smart Picks is unmatched. I’ve learned so much and made steady profits.",
  },
  {
    name: "Ethan Brooks",
    location: "Chicago, IL",
    text: "With J-Smart Picks, I finally feel confident placing my bets. Their predictions are on point.",
  },
  {
    name: "Isabella Turner",
    location: "Miami, FL",
    text: "The Discord community is amazing, and the J-Smart Picks team is always active and supportive.",
  },
  {
    name: "Mason Lee",
    location: "Dallas, TX",
    text: "I’ve tried other tipsters, but J-Smart Picks stands out with accuracy and professionalism.",
  },
  {
    name: "Ava Mitchell",
    location: "Phoenix, AZ",
    text: "Clear, concise, and reliable betting advice. My bankroll has never looked better.",
  },
  {
    name: "Noah Wilson",
    location: "Philadelphia, PA",
    text: "The giveaways are a fun bonus, but the real win is the consistent betting edge.",
  },
  {
    name: "Mia Robinson",
    location: "Las Vegas, NV",
    text: "Even here in Vegas, J-Smart Picks gives me angles the sportsbooks don’t see.",
  },
  {
    name: "James Anderson",
    location: "Seattle, WA",
    text: "The lifetime membership is worth every penny. I trust their calls completely.",
  },
  {
    name: "Charlotte Martinez",
    location: "Denver, CO",
    text: "Since joining, my confidence and winnings have soared. Highly recommend J-Smart Picks!",
  },
];
...
const Card = ({ t }) => (
  <div className="bg-[#141b2d] p-4 sm:p-5 md:p-6 rounded-2xl shadow-lg border border-[#ff0033]/10 hover:border-[#ff0033]/40 transition h-full">
    ...
    <p className="text-gray-300 italic mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base">
      "{t.text}"
    </p>
